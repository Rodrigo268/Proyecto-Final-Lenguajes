...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        initComponents();
       btnCargarEmpleados.setText("Cargar Empleados");
    ...
    private void btnCargarEmpleadosActionPerformed(java.awt.event.ActionEvent evt) {
        cargar_empleados ventana = new cargar_empleados();
